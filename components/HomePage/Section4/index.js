        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-4 md:space-x-3 ">
          {data.map((data) => (
            ...
            >
              ...
              >
                <p className="font-[500] text-xs md:text-xl font-lexend">
                  {data.title}
                </p>
              </div>
              <div
                data-aos="fade-up"
                className=" hidden md:flex justify-center mt-11 mb-10"
              >
                <img
              ...
              <div
                data-aos="fade-right"
                className="md:hidden font-libre-bodoni text-lg mb-3 font-bold text-grayHead"
              >
                {data.title}
              </div>
              <div
                data-aos="flip-down"
                className=" shadow-2xl hover:cursor-pointer flex flex-col justify-center p-3   rounded-2xl bg-grayIcon bg-opacity-90 w-[85%] h-72  md:w-80 md:h-80"
              >
