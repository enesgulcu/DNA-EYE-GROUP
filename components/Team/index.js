  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="flex justify-center items-center mt-10">
        <div className="lg:w-[90%] flex justify-center items-center flex-col">
          <div className=" md:text-4xl text-xl  text-darkRed font-medium my-10">
            <span>Our Arizona Locations</span>
          </div>
          <div className="grid md:grid-cols-3 font-libre-bodoni grid-cols-1 w-[90%]">
            {data.map((item) => (
              <div
                data-aos="flip-left"
                data-aos-duration="1200"
                key={item.id}
                className="flex flex-col gap-2 lg:gap-3 p-3"
              >
                ...
                <div className="text-center mt-5 text-2xl font-[500]">
                  <span>{item.title}</span>
                </div>
                <Link href={item.linkPath}>
                  <div className="text-center hover:underline h-16">
