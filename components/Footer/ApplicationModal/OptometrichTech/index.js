...
function OptometrichTech({
  openOptometrichTechModal,
  goBack,
  handleCloseModal,
}) {
  ...
  const submitHandler = async (values, { resetForm }) => {
    ...
    fileReader.onload = async function (e) {
      ...
      const emailMessage = `
    From Web, Carreer Oppurtunities (Optometrich Tech) Form:
    ...
    ${openOptometrichTechModal ? "flex" : "hidden"} `}
      >
        <div className="bg-bodybg h-[80%]  rounded-lg shadow-md md:w-[40%] w-[80%] flex flex-col ">
          ...
          <div className=" mt-8 text-center font-[500] text-2xl text-redTitle">
          ...
          >
            ...
            <div className="w-full">
              ...
              >
                ...
                <input
                  id="optom-file-upload"
                  name="optom-file-upload"
                  accept=".pdf, .doc, .docx"
                  type="file"
                  className="sr-only"
