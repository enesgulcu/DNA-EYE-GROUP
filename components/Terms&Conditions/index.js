    ...
    return (
        <main className="min-h-screen">
            ...
            <div className="bg-redTitle h-[270px] flex items-center justify-center relative">
                <h1 className="text-white text-5xl font-bold text-center drop-shadow-md">Terms & Conditions</h1>
            </div>

            {/* Content section */}
            <div className="max-w-4xl mx-auto px-6 py-16">
                <p className="text-gray-600 leading-relaxed">
                    DNA Eye Group (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) provides this website (&ldquo;Site&rdquo;) to you conditioned on your acceptance without modification of the terms, conditions, and notices contained herein.
                    Your use of this site constitutes your agreement to all such terms, conditions, and notices.
                </p>
            </div>
            <div className="max-w-4xl mx-auto px-6 py-16">
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">MODIFICATION OF THESE TERMS OF USE
                </h2>
            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">LINKS TO THIRD PARTY SITES</h2>
                ...
                <p className="text-gray-600 leading-relaxed">
                    ...
                    We are providing these links to you only as a convenience, and the inclusion of any link does not imply endorsement by us of the site or any association with its operators.
                </p>
            </div>
            <div className="max-w-4xl mx-auto px-6 py-16">
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">NO UNLAWFUL OR PROHIBITED USE</h2>

                <p className="text-gray-600 leading-relaxed">
                    As a condition of your use of this Site, you warrant to us that you will not use this Site for any purpose that is unlawful or prohibited by these terms, conditions, and notices.
                    You may not use this Site in any manner which could damage, disable, overburden, or impair this Site or interfere with any other party&apos;s use and enjoyment of this Site.
                    You may not obtain or attempt to obtain any materials or information through any means not intentionally made available or provided for through this Site.
                </p>
            </div>
            <div className="max-w-4xl mx-auto px-6 py-16">
                ...
                <p className="text-gray-600 leading-relaxed">
                    ...
                    <ul className="list-disc pl-6 text-gray-600 leading-relaxed">
                        <li>Personal and confidential information, including phone numbers, addresses, and health information.</li>
                        <li>Vulgar content, including offensive, derogatory, obscene, profane, or inflammatory language or content.</li>
                        <li>Threats or personal attacks on others.</li>
                        <li>Discriminatory content or hate speech, including content that advocates against groups of people based on their race, ethnic origin, religion, disability, gender, gender identity, sexual orientation, age, or veteran status.</li>
                        <li>Misrepresentations, including content submitted fraudulently on behalf of others or that misrepresents the your identity or connection with us or our practice.</li>
                        <li>Non-applicable content, including posts that are not specific to us or our practice.</li>
                        <li>Advertising or solicitations.</li>
                        <li>Illegal content or references to or information about ongoing legal matters or proceedings.</li>
                    </ul>
                    <br></br>
                    You further agree that you will not:
                    <ul className="list-disc pl-6 text-gray-600 leading-relaxed">
                        <li>Upload files that contain software or other material protected by intellectual property laws (or by rights of privacy of publicity) unless you own or control the rights there to or have received all necessary consents.</li>
                        ...
                        <li>Falsify or delete any legal or other proper notices or proprietary designations or labels of the origin or source of software or other material contained in a file that is uploaded.</li>
            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                <p className="text-gray-600 leading-relaxed">
                    ...
                    However, we reserve the right to review materials posted to a Communication Service and to remove any content that does not comply with these terms or any publicly posted content that includes personal and confidential information.
                    ...
                    Content uploaded to a Communication Service may be subject to posted limitations on usage, reproduction, and/or dissemination. You are responsible for adhering to such limitations if you download the content.
                    If you would like to remove your own review from this Site, please contact us.
                </p>
            </div>
            <div className="max-w-4xl mx-auto px-6 py-16">
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">LIABILITY DISCLAIMER</h2>
            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">COPYRIGHT AND TRADEMARK NOTICES</h2>

                <p className="text-gray-600 leading-relaxed">
                    All contents of this website are Copyright © 2025 DNA Eye Group, Inc. All Rights Reserved.
                    All logos are trademarks and service marks of DNA Eye Group, Inc.
                    All other trademarks, service marks and logos used in this Site are the property of their respective owners.
                </p>
            </div>
            <div className="max-w-4xl mx-auto px-6 py-16">
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">TRADEMARKS</h2>
            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">NOTICES</h2>

                <p className="text-gray-600 leading-relaxed">
                    Please contact us by phone at (480) 726-7009 or by mail at dnaeyegroup@gmail.com with any questions or comments.
                </p>
            </div>
        </main>
    )
