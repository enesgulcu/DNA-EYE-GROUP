    ...
    <Container>
      <main className="min-h-screen">
        ...
        <div className="bg-redTitle h-[270px] flex items-center justify-center relative">
          <h1 className="text-white text-5xl font-bold text-center drop-shadow-md">
            Terms & Conditions
          </h1>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          <p className="text-gray-600 leading-relaxed">
            DNA Eye Group (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or
            &ldquo;our&rdquo;) provides this website (&ldquo;Site&rdquo;) to you
        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            charges associated with the use of this Site. You are responsible
        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <p className="text-gray-600 leading-relaxed">
            This Site may contain links to other websites (&quot;Linked
            Sites&quot;). The Linked Sites are not under our control and we are
            ...
            changes or updates to a Linked Site. We are not responsible for
            webcasting or any other form of transmission received from any
            Linked Site. We are providing these links to you only as a
            convenience, and the inclusion of any link does not imply
            endorsement by us of the site or any association with its operators.
          </p>
        </div>
        <div className="max-w-4xl mx-auto px-6 py-16">
          <h2 className="text-2xl font-semibold mb-6 text-gray-800">
        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <div className="text-gray-600 leading-relaxed">
            When using this Site, you may have the odivportunity to submit
            ...
            communication features designed to enable you to communicate with
            ...
            <ul className="list-disc pl-6 text-gray-600 leading-relaxed">
              ...
              <li>
                ...
                behalf of others or that misrepresents the your identity or
                connection with us or our practice.
              </li>
              <li>
                Non-applicable content, including posts that are not specific to
                us or our practice.
              </li>
              <li>Advertising or solicitations.</li>
              <li>
                Illegal content or references to or information about ongoing
            ...
            <ul className="list-disc pl-6 text-gray-600 leading-relaxed">
              <li>
                ...
                publicity) unless you own or control the rights there to or have
        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          <p className="text-gray-600 leading-relaxed">
            ...
            Communication Service and to remove any content that does not comply
            with these terms or any publicly posted content that includes
            personal and confidential information. We reserve the right to
            terminate your access to any or all of the Communication Services at
            any time without notice for any reason whatsoever. Content uploaded
            to a Communication Service may be subject to posted limitations on
            usage, reproduction, and/or dissemination. You are responsible for
            adhering to such limitations if you download the content. If you
            would like to remove your own review from this Site, please contact
            us.
          </p>
        </div>
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            INFORMATION HEREIN. WE AND/OR OUR SUPPLIERS MAY MAKE IMPROVEMENTS
            AND/OR CHANGES IN THIS SITE AT ANY TIME. ADVICE RECEIVED VIA THIS
            SITE SHOULD NOT BE RELIED UPON FOR PERSONAL, MEDICAL, LEGAL OR
            FINANCIAL DECISIONS AND YOU SHOULD CONSULT AN APPROPRIATE
            PROFESSIONAL FOR SPECIFIC ADVICE TAILORED TO YOUR SITUATION. WE
            AND/OR OUR SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE SUITABILITY,
            ...
            IS&quot; WITHOUT WARRANTY OR CONDITION OF ANY KIND. WE AND/OR OUR
            ...
            IN NO EVENT SHALL WE AND/OR OUR SUPPLIERS BE LIABLE FOR ANY DIRECT,
            ...
            WITH THE USE OR PERFORMANCE OF THIS SITE, WITH THE DELAY OR
            ...
            PRODUCTS, SERVICES AND RELATED GRAPHICS OBTAINED THROUGH THIS SITE,
            OR OTHERWISE ARISING OUT OF THE USE OF THIS SITE, WHETHER BASED ON
            CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY OR OTHERWISE, EVEN IF
            WE OR ANY OF OUR SUPPLIERS HAS BEEN ADVISED OF THE POSSIBILITY OF
        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <p className="text-gray-600 leading-relaxed">
            All contents of this website are Copyright © 2025 DNA Eye Group,
            Inc. All Rights Reserved. All logos are trademarks and service marks
            of DNA Eye Group, Inc. All other trademarks, service marks and logos
            used in this Site are the property of their respective owners.
          </p>
        </div>
        <div className="max-w-4xl mx-auto px-6 py-16">
          <h2 className="text-2xl font-semibold mb-6 text-gray-800">
        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <p className="text-gray-600 leading-relaxed">
            Please contact us by phone at (480) 726-7009 or by mail at
            dnaeyegroup@gmail.com with any questions or comments.
          </p>
        </div>
      </main>
    </Container>
